...
int KqueueSelect::removeWatcher(Watcher *w)
{
    int ret = 0;
...
int KqueueSelect::updateWatcher(Watcher *w)
{
    int ret = 0;
...
int KqueueSelect::update(int operation, Watcher *w)
{
    struct kevent ke;
    int filter = 0;
