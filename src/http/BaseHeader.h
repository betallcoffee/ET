...
namespace ET {
    ...
    namespace HTTP {
        ...
        public:
            ...
            static const std::string kUpgrade; // 给出发送端可能想要“升级”使用的新版本或协议。
            ...
            // WebSocket
            static const std::string kSecWebSocketKey; // 检验作用
            static const std::string kSecWebSocketAccept; // base64(kSecWebSocketKey+GUID)
            static const std::string kSecWebSocketProtocol; // 指示 websocket 子协议
            static const std::string kSecWebSocketVersion; // 指示 websocket 版本号
            static const std::string kSecWebSocketExtensions; //
            // WebSocket
        ...
        protected:
            ...
            std::string _upgrade; // 给出发送端可能想要“升级”使用的新版本或协议。
            ...
            std::string _secWebSocketAccept;
            std::vector<std::string> _secWebSocketProtocols;
            int _secWebSocketVersion;
            std::string _secWebSocketExtensions;
